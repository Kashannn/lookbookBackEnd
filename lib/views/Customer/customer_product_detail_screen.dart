...
import 'package:lookbook/utils/components/product_action_button.dart';
...
class CustomerProductDetailScreen extends StatelessWidget {
  CustomerProductDetailScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final Future<bool> isHome =
        firebaseCustomerEndServices.isProductInHome(product.id!);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: CustomAppBar(),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //     text: 'ADD TO HOME',
                    //     ontap: () {
                    //       firebaseCustomerEndServices.addProductToHome(product);
                    //     },
                    //     color: AppColors.secondary,
                    //     icon: Icons.east,
                    //   )
