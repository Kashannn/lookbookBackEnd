...
class CustomerMessageChatScreen extends StatefulWidget {
  ...
  const CustomerMessageChatScreen({
    super.key,
...
class _CustomerMessageChatScreenState extends State<CustomerMessageChatScreen> {
  ...
  void sendMessage() async {
    ...
    // Store the message text in a local variable before clearing the controller
    String messageText = text;

    // Clear the input field after saving the message text
    ...
    UserModel? userModel = await customerEndServices.fetchUser(widget.otherUserId);
    UserModel? currentUserModel = await customerEndServices.fetchUser(widget.currentUserId);

    // Use the actual message text in the notification
    NotificationService().chatSendPushNotification(
      currentUserModel!.fullName ?? '',
      userModel!.deviceToken!,
      messageText, // Send the actual message instead of "has messaged you"
      widget.otherUserId,
      "chat",
              ...
              child: Row(
                ...
                children: [
                  CircleAvatar(
                    ...
                    child: ClipOval(
                      child: widget.designer.imageUrl != null &&
                              widget.designer.imageUrl!.isNotEmpty
                          ? Stack(
                              children: [
                          ...
                          : Container(
                              ...
                              child: Center(
                                child: Text(
                                  getInitials(widget.designer.fullName ?? ''),
                                  style: tSStyleBlack18500.copyWith(
                                    color: AppColors.white,
                                  ),
                                ),
                  ...
                  Padding(
                    ...
                    child: Text(widget.designer.fullName! ?? '',
                        style: TextStyle(
                          fontFamily: 'Inter',
                        ...
                        return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return _buildChatBubble(
                                  ...
                                  avatar: widget.designer.imageUrl,
                                  image: message.img,
